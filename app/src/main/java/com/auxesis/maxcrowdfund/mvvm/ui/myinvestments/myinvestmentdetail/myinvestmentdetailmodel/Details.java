...
public class Details {
    ...
    @SerializedName("change_button_alowed")
    @Expose
    private Integer changeButtonAlowed;
    ...
    public Integer getChangeButtonAlowed() {
        return changeButtonAlowed;
    }

    public void setChangeButtonAlowed(Integer changeButtonAlowed) {
        this.changeButtonAlowed = changeButtonAlowed;
    }
