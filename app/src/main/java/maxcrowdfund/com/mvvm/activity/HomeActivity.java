...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mName = Utils.getPreference(HomeActivity.this, "mName").toLowerCase();
        if (mName != null && !mName.isEmpty()) {
            String userName = mName.substring(0, 1).toUpperCase() + mName.substring(1);
            tv_user_name.setText(userName);
        }
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_investment_opp, R.id.nav_dashboard,R.id.nav_my_account,R.id.nav_my_wallet,R.id.nav_my_investments,
                R.id.nav_my_portfolio,R.id.nav_my_profile, R.id.nav_contact_information,R.id.nav_logout)
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, APIUrl.GER_CHECK_USER, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (status.equals("1")) {
                        ...
                        Utils.setPreference(HomeActivity.this, "user_id", "");
                        Utils.setPreference(HomeActivity.this, "mLogout_token", "");
                ...
                public Map getHeaders() throws AuthFailureError {
                    ...
                    String mCsrfToken = Utils.getPreference(HomeActivity.this, "mCsrf_token");
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (jobj != null) {
                            ...
                            Utils.setPreference(HomeActivity.this, "isRememberMe", "");
                            Utils.setPreference(HomeActivity.this, "user_id", "");
                            Utils.setPreference(HomeActivity.this, "mLogout_token", "");
                            MaxCrowdFund.getInstance().getClearCookies(HomeActivity.this, "cookies", "");
                            Toast.makeText(HomeActivity.this, getResources().getString(R.string.logout_succ), Toast.LENGTH_SHORT).show();
