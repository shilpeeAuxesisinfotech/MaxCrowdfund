package maxcrowdfund.com.mvvm.ui.dashborad.dashboarddeposit;
...
public class DashboardDepositFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (Utils.getPreference(getActivity(), "totalBalance") != null && !Utils.getPreference(getActivity(), "totalBalance").isEmpty()) {
            tvTrustly.setText(Utils.getPreference(getActivity(), "totalBalance"));
        }
